...
const initialState: UserWithId[] = (() => {
	// Función autoinvocada (IIFE) que devuelve un array de usuarios
...
export const { addNewUser, deleteUserById, rollbackUser } = userSlice.actions; // ← Acciones para interactuar
